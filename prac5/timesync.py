...
def udpSendThread():
  ...
  while isRunning:
    ...
    sock.sendto(struct.pack("I", timestamp), ("aaaa::212:4b00:c2a:ab83", UDP_TIMESYNC_PORT))
    sock.sendto(struct.pack("I", timestamp), ("aaaa::212:4b00:1204:bd99", UDP_TIMESYNC_PORT))   # sock.sendto(struct.pack("I", timestamp), ("Address For Sensortag2", UDP_TIMESYNC_PORT))
